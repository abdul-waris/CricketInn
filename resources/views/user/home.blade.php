...
<hr>
                    ...
                    <div class="latest-news">
                       <div class="thumb col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <img src="images.jpg" class="img-responsive" alt="latest news" style="height:500px ; margin-left:-15px; border-top-left-radius: 11px">
                       </div>
