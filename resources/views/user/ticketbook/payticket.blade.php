...
<div class="form-group">
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
            <p class="form-control-static">{{$groundaddress->groundname}}</p>
        </div>
    </div>
...
<div class="form-group">
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
            <p class="form-control-static">{{$groundaddress->city}}</p>
        </div>
    </div>
...
<div class="form-group">
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
            <p class="form-control-static">{{$groundaddress->province}}</p>
        </div>
    </div>
