...
<!--<style>
 ...
 <!--<div class="container">
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox"><a href="#"> Imran Khan </a> </p></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox"><a href="#"> Amir </a></p></div>
            <div class="clearfix visible-sm-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox"><a href="#"> Shahid afridi </a></p></div>
            <div class="clearfix visible-md-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 4</p></div>
            <div class="clearfix visible-sm-block"></div>
            <div class="clearfix visible-lg-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 5</p></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 6</p></div>
            <div class="clearfix visible-sm-block"></div>
            <div class="clearfix visible-md-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 7</p></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 8</p></div>
            <div class="clearfix visible-sm-block"></div>
            <div class="clearfix visible-lg-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 9</p></div>
            <div class="clearfix visible-md-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 10</p></div>
            <div class="clearfix visible-sm-block"></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 11</p></div>
            <div class="col-sm-6 col-md-4 col-lg-3"><p id="ticketbox">Box 12</p></div>
        </div>
    </div>-->
